...
// const cors = require('cors');
const whitelist = ['http://localhost:7000','http://localhost:3000', 'http://2b606649.ngrok.io', 'https://e-commerce-shop-back.herokuapp.com','https://e-commerce-shop-back.herokuapp.com/api/user/login']
